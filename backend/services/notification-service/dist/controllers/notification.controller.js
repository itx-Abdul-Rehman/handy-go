import { successResponse, paginatedResponse, notFoundResponse, asyncHandler, logger, Notification, } from '@handy-go/shared';
 ...
 */
export const sendTemplatedNotification = asyncHandler(async (req, res) => {
...
export const markAsRead = asyncHandler(async (req, res) => {
    ...
    const notification = await Notification.findOneAndUpdate({ _id: notificationId, recipient: userId }, { isRead: true, readAt: new Date() }, { new: true });
    if (!notification) {
...
export const registerDevice = asyncHandler(async (req, res) => {
    ...
    // Upsert device token
    await DeviceToken.findOneAndUpdate({ user: userId, token: deviceToken }, {
        user: userId,
        token: deviceToken,
        platform,
        isActive: true,
...
export const unregisterDevice = asyncHandler(async (req, res) => {
    ...
    await DeviceToken.findOneAndUpdate({ user: userId, token: deviceToken }, { isActive: false });
