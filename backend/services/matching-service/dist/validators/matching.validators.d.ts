import Joi from 'joi';
export declare const analyzeProblemSchema: Joi.ObjectSchema<any>;
export declare const findWorkersSchema: Joi.ObjectSchema<any>;
export declare const estimatePriceSchema: Joi.ObjectSchema<any>;
