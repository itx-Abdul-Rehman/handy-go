...
const typedPriceBaselines = priceBaselines;
/**
 ...
 */
const determineComplexity = (description, category) => {
    ...
    if (complexScore > basicScore && complexScore >= 2)
        return 'complex';
    if (basicScore > complexScore && basicScore >= 1)
        return 'basic';
    return 'medium';
};
/**
 ...
 */
const getLocationMultiplier = (city) => {
...
//# sourceMappingURL=price-predictor.js.map